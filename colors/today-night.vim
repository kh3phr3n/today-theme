...
call s:Hl('CursorLine'  , 'foreground', 'line'      , 'none')
...
call s:Hl('ModeMsg'     , 'green'     , 'background', 'none')
...
call s:Hl('TabLine'     , 'foreground', 'selection' , 'none')
call s:Hl('TabLineFill' , 'foreground', 'selection' , 'none')
